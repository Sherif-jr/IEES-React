...
const Home1 = (props) => {
  return (
    <div className="home1-container">
      <Helmet>
        <title>Home1 - IEES</title>
        <meta property="og:title" content="Home1 - IEES" />
      </Helmet>
      <Header></Header>
      <div className="home1-hero">
        <div className="home1-container01">
          <div className="home1-card">
            <h1 className="home1-text HeadingOne animate-gradient">
              CHILL, MANAGE, SAVE
            </h1>
            <h1 className="home1-text01 HeadingOne">Choose the best</h1>
            <span className="home1-text02 Lead">
              <span>
            ...
            <div className="home1-container02">
              <div className="home1-container03">
                <PrimaryGreenButton button="contact us"></PrimaryGreenButton>
              </div>
      ...
      <img
        alt="image"
        src="https://images.unsplash.com/photo-1541888946425-d81bb19240f5?ixid=Mnw5MTMyMXwwfDF8c2VhcmNofDExfHxlbmdpbmVlcmluZ3xlbnwwfHx8fDE2NzA3NjM2NzY&amp;ixlib=rb-4.0.3&amp;h=1500"
        loading="lazy"
      ...
      <section className="home1-container06">
        <div className="home1-container07">
          <h1 className="home1-text05 HeadingOne">
            <span className="home1-text06">From nothing to something</span>
          </h1>
        ...
        <div className="home1-container08">
          <div className="home1-container09">
            ...
            />
            <span className="home1-text09 Small">
              ...
              <br></br>
              <span className="home1-text12">-NOAA</span>
            </span>
      ...
      <section className="home1-testimonials">
        <div className="home1-container13">
          <div className="home1-container14">
            <div className="home1-container15">
              <h2 className="home1-text23 HeadingOne">Work with us</h2>
              <p className="home1-text24 Lead">
                <span className="home1-text25">
                  Whatever your qualification is - we got you!
                </span>
              </p>
              <p className="home1-text26 Body">
              ...
              <p className="home1-text28">Mark Jojansen</p>
              <p className="home1-text29 Small">Project manager, Atlassian</p>
              <div className="home1-container16">
                ...
                />
                <div className="home1-container17"></div>
                <img
                  alt="image"
                  src="/playground_assets/team-3-200h.jpg"
                  className="home1-image06"
                />
                <div className="home1-container18"></div>
                <img
                  alt="image"
        ...
        <img
          ...
          className="home1-bottom-wave-image"
        />
        <img
          alt="image"
        ...
        <img
          ...
          className="home1-top-wave-image"
        />
      </section>
      <section className="home1-contaier">
        <div className="home1-container31">
          ...
          <h2 className="home1-text30 HeadingTwo">
            <span className="home1-text31">Beware The Components</span>
          </h2>
          <h3 className="home1-text32 HeadingTwo">
            <span className="home1-text33">How To Handle Them</span>
            <br></br>
          </h3>
        ...
        <div className="home1-container33">
          <div className="home1-container34">
            <div className="home1-container35"></div>
            <div className="home1-container36">
              <svg viewBox="0 0 987.4285714285713 1024" className="home1-icon2">
              ...
              <h1 className="home1-text36 HeadingOne">Search and Discover!</h1>
        ...
        <div className="home1-container38">
          ...
          <div className="home1-container40">
            <div className="home1-container41"></div>
            <div className="home1-container42">
              <svg viewBox="0 0 1152 1024" className="home1-icon4">
              ...
              <h1 className="home1-text40 HeadingOne">Talk and Meet!</h1>
